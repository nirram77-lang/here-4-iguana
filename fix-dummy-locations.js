...
const YOUR_LAT = 31.6969702;
const YOUR_LNG = 34.577887;
...
async function fixDummyUsers() {
  ...
  try {
    ...
    for (const docSnap of snapshot.docs) {
      ...
      console.log(`🔧 Fixing ${user.name || user.displayName || 'Unknown'}`);
    ...
    console.log(`🎉 SUCCESS! Fixed ${fixed} out of ${snapshot.size} users`);
