        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden lg:flex items-center gap-3">
              <a href="#how-it-works" className="text-gray-300 hover:text-green-400 transition-colors whitespace-nowrap text-sm">Como Funciona</a>
              <a href="#features" className="text-gray-300 hover:text-green-400 transition-colors whitespace-nowrap text-sm">Recursos</a>
              <a href="#for-venues" className="text-gray-300 hover:text-green-400 transition-colors whitespace-nowrap text-sm">Estabelecimentos</a>
              <a href="#download" className="text-gray-300 hover:text-green-400 transition-colors whitespace-nowrap text-sm">Download</a>
              
              {/* Language Switcher */}
              <div className="flex items-center gap-1">
                <Link 
                  href="/"
                  className="px-2 py-1 bg-white/10 border border-white/30 rounded-full text-xs font-bold text-white hover:bg-white/20 transition-all flex items-center gap-1"
                >
              ...
              <div className="relative">
                ...
                {showShareMenu && (
                  <div className="absolute top-full right-0 mt-2 bg-[#0d2920] border border-green-500/30 rounded-xl shadow-xl p-2 min-w-[180px] z-50">
                    <button onClick={() => handleShare('whatsapp')} className="w-full text-left px-4 py-2 hover:bg-green-500/20 rounded-lg flex items-center gap-2">
                      <span>💬</span> WhatsApp
                    </button>
                    <button onClick={() => handleShare('email')} className="w-full text-left px-4 py-2 hover:bg-green-500/20 rounded-lg flex items-center gap-2">
                      <span>📧</span> Email
                    </button>
                    <button onClick={() => handleShare('copy')} className="w-full text-left px-4 py-2 hover:bg-green-500/20 rounded-lg flex items-center gap-2">
              ...
              <Link 
                href="/app"
                className="px-4 py-1.5 bg-gradient-to-r from-green-500 to-emerald-600 rounded-full text-sm font-semibold hover:shadow-lg hover:shadow-green-500/30 transition-all whitespace-nowrap"
              >
                Abrir App
              </Link>
            </div>
          ...
          {/* Mobile Menu */}
          {menuOpen && (
            <div className="lg:hidden absolute top-full left-0 right-0 bg-[#0a1f1a]/98 backdrop-blur-lg border-b border-white/10 px-6 py-6 space-y-4 shadow-2xl">
              ...
              <a href="#for-venues" onClick={() => setMenuOpen(false)} className="block text-gray-300 hover:text-green-400 py-2">Para Estabelecimentos</a>
              <a href="#download" onClick={() => setMenuOpen(false)} className="block text-gray-300 hover:text-green-400 py-2">Download</a>
              
              {/* Language Switcher - Mobile */}
              <div className="flex items-center gap-2 py-2">
                <Link href="/" className="px-3 py-1.5 bg-white/10 border border-white/30 rounded-full text-sm font-bold text-white flex items-center gap-1">
                ...
                <Link href="/he" className="px-3 py-1.5 bg-white/10 border border-white/30 rounded-full text-sm font-bold text-white flex items-center gap-1">
                  <svg className="w-5 h-4" viewBox="0 0 640 480">
                    <path fill="#fff" d="M0 0h640v480H0z"/>
                    <path fill="#0038b8" d="M0 57.6h640v48H0zm0 316.8h640v48H0z"/>
                    <path fill="#0038b8" d="M320 146.4l-54.6 94.6h109.2zm0 187.2l-54.6-94.6h109.2zm0-160.8l-54.6 94.6 54.6 31.8 54.6-31.8zm0 134.4l-54.6-94.6 54.6-31.8 54.6 31.8z" fillRule="evenodd"/>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center px-6 max-w-4xl mx-auto pt-20">
          ...
          <h1 className="text-5xl md:text-7xl font-black mb-6 leading-tight animate-fadeInUp">
            <span className="text-white">Sem swipes infinitos.</span>
            <br />
            <span className="text-white">Sem joguinhos.</span>
            <br />
          ...
          <p className="text-xl md:text-2xl text-gray-400 mb-4 max-w-2xl mx-auto animate-fadeInUp" style={{animationDelay: '0.2s'}}>
            <span className="text-pink-400">Pessoas reais.</span> <span className="text-white">Lugares reais.</span> <span className="text-green-400 font-semibold">10-500 metros de você.</span>
          </p>
          ...
          <div className="flex items-center justify-center gap-8 md:gap-16 mt-16 animate-fadeInUp" style={{animationDelay: '0.6s'}}>
            <div className="text-center">
              ...
              <div className="text-gray-500 text-sm">Distância Mín.</div>
            </div>
            <div className="w-px h-12 bg-white/20"></div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-green-400">500m</div>
              <div className="text-gray-500 text-sm">Alcance Máx.</div>
            </div>
            <div className="w-px h-12 bg-white/20"></div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-green-400">Tempo</div>
              <div className="text-gray-500 text-sm">Real</div>
            </div>
          </div>
        </div>
      ...
      <section id="features" className="py-24 px-6 bg-gradient-to-b from-[#0d2920] to-[#0a1f1a]">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="bg-[#1a4d3e]/30 backdrop-blur-sm rounded-2xl p-6 border border-green-500/20 hover:border-green-500/40 transition-colors">
