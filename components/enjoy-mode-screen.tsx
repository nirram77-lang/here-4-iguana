...
export default function EnjoyModeScreen({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0a1f18] via-[#0d2920] to-[#051410] flex flex-col">
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 py-8">
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-3">
            ...
            <span className="text-white/60 text-sm">App returns in</span>
          </div>
        ...
        >
          ...
          <p className="text-white/80 text-sm leading-relaxed">
            This moment is yours! Look up from the screen and enjoy the real connection ✨
          </p>
        </motion.div>
            ...
            >
              <div className="text-center mb-8">
                ...
                <p className="text-white/70 text-base leading-relaxed">
                  The Iguana is always here for you.
                  <br />
                  <span className="text-[#4ade80]">Let's find your next match!</span>
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                >
                  <Heart className="mr-2 h-5 w-5 text-[#4ade80]" />
                  No, Stay Here 💚
                </Button>
              </div>
            </motion.div>
